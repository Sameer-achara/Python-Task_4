...
![Topic](https://img.shields.io/badge/Topic-OOP-FF6B35?style=for-the-badge)
![Concepts](https://img.shields.io/badge/Concepts-Classes%20%7C%20Inheritance%20%7C%20Polymorphism-6A0DAD?style=for-the-badge)
![Type](https://img.shields.io/badge/Type-Internship%20Project-28A745?style=for-the-badge)
![Status](https://img.shields.io/badge/Status-Completed-success?style=for-the-badge)
![Paradigm](https://img.shields.io/badge/Paradigm-Object--Oriented-E91E63?style=for-the-badge)
...
- [Theory Notes](#-theory-notes)
  ...
  - [Constructors](#2-constructors-__init__)
  - [Instance Variables and Methods](#3-instance-variables-and-methods)
  - [Class Variables](#4-class-variables)
  - [Encapsulation](#5-encapsulation)
  - [Inheritance](#6-inheritance)
  - [Polymorphism](#7-polymorphism)
  - [Abstraction](#8-abstraction)
  - [Method Overriding](#9-method-overriding)
  - [super() Function](#10-super-function)
  - [Access Modifiers](#11-access-modifiers)
...
s1 = Student("Sameer", 21)
print(s1.name)   # Output: Sameer
...
s = Student("Sameer", 21, "STU001")
s.display()
# Output: Name: Sameer, Age: 21, ID: STU001
```
...
s = Student("Sameer")
print(s.name)               # Accessible directly — Output: Sameer
```
...
![OOP](https://img.shields.io/badge/Paradigm-OOP-FF6B35?style=flat-square)
![Internship](https://img.shields.io/badge/Program-Internship-28A745?style=flat-square)
